              ...
              <div className="flex flex-col gap-2 justify-end">
                ...
                {!item.cancelled && !item.payment && !item.isCompleted && (
                  ...
                  <button
                    ...
                    onClick={() => appointmentStripePayment(item._id)}
                  >
                    {payingId === item._id ? "Redirecting..." : "Pay with Stripe"}
                  </button>
                ...
                {!item.cancelled && !item.isCompleted && (
                  <button
                    ...
                    className={`text-md text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600 hover:text-white transition-all duration-300 ${item.payment ? "cursor-not-allowed" : ""
                      }`}
                  >
                    Cancel Appointment
                  </button>
