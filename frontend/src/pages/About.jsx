    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-lg text-gray-600">
          <p>
            Welcome to HMS, your trusted partner in managing your
            healthcare needs conveniently and efficiently. At HMS, we
          ...
          <p>
            ...
            ongoing care, HMS is here to support you every step of the
            way.
          </p>
          <strong className="text-gray-800">Our Vision</strong>
          <p>
            Our vision at HMS is to create a seamless healthcare
